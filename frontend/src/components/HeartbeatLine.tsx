...
const HeartbeatLine = () => {
  return (
    <div className="absolute bottom-[10rem] left-0 w-full overflow-hidden">
      ...
      >
        <motion.path
          d="M0 10 H60 L70 1 L80 20 L90 10 H120 L130 2 L140 18 L150 10 H180 L190 5 L200 15 L210 10 H240 L250 1 L260 20 L270 10 H300 L310 5 L320 15 L330 10 H360 L370 2 L380 18 L390 10 H420 L430 5 L440 15 L450 10 H480 L490 5 L500 15 L510 10 H540 L550 1 L560 20 L570 10 H600"
          stroke="#add8e6"
          strokeWidth="1"
          fill="none"
